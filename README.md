...
这是我的“力学博士自学计算机与 AI”长期学习仓库。

本仓库用于记录我从力学专业背景出发，系统学习计算机基础、Python 科研编程、机器学习、深度学习、大模型工程和科学机器学习的全过程。
...
1. 掌握 Python 科研编程能力；
2. 熟悉 Linux、Git、GitHub、conda 等科研开发工具；
3. 掌握计算机基础、算法与数据结构；
4. 掌握机器学习和深度学习的基本理论与实践；
5. 掌握大模型、RAG、Agent 等 AI 工程方法；
6. 将 AI 方法与力学、数值仿真、FEM、PINN、Neural Operator 等方向结合；
7. 最终形成 AI + 力学方向的科研能力和项目成果。
...
- 熟悉 WSL Ubuntu 开发环境
- 使用 Miniforge / conda 管理 Python 环境
- 使用 Git 和 GitHub 管理学习代码
- 建立规范科研项目结构
- 完成第一次环境测试和 GitHub 同步
